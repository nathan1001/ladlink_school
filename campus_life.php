		...
		<section class="uk-section uk-padding-remove uk-margin-large-top" >
				<div class="uk-text page-heading uk-text-large uk-text-capitalize uk-margin-large-left splash-burgundy splash-charter section-title">Campus Life</div>
			<div class="page-hero" style="background-image: url(images/adult-brainstorming-business-1181622.jpg)"></div>
				
			<div class="intro-section-container spring-wood-bg">
			<div class="intro-text-container uk-padding">
					<div class="uk-padding uk-text uk-text-left">
						<h3 class="uk-text-left column-title"><span>Welcome Message from the Head</span></h3>
						<p class="uk-margin-large-top">
							Fountainhead Christian School was founded in 2001 by Rev. Faithful and Rev. Mrs. Mary Biney. In 1984, they moved back to Ghana with the vision and passion to touch many lives. Since then, they have reached out through Leadership Training Programs and Mercy Ministries.<br>
							Recognizing the need for quality transformational basic education, they started two schools; Fountainhead Christian school, Sakumono-Tema and Calvary Academy in the heart of the central region. More recently they have branched out into tertiary education – Fountainhead Christian College at community 12, Tema.
						</p>
				...
				<div class="uk-text bg-intro-text uk-text-large uk-text-capitalize muted-page-title splash-white">Campus Life</div>
			</div>
			<div class="campus-life-calendar">
					<div class="uk-padding ">
						<div class="uk-text-capitalize uk-text-center calendar-title"><div class="column-title splash-white">Calendar</div>
						</div>
						<div class="calendar-events">							
							<p class="uk-margin-left splash-white splash-charter">
								<span class="calendar-header">Dec 9</span> <br>
								<span class="splash-verdana calendar-body">A lesson of 9 Lessons and Carols.</span>
							</p>
							<p class="uk-margin-left splash-white splash-charter">
								<span class="calendar-header">Dec 9</span> <br>
								<span class="splash-verdana calendar-body">A lesson of 9 Lessons and Carols.</span>
		...
		<section class="uk-section uk-padding">
			<div class="uk-padding uk-text"><div class="uk-text-left splash-burgundy splash-charter section-title"><span>Boarding School</span></div></div>
			<div class="uk-padding-large uk-text">
				<div class=" uk-text-left" >
					<div class="fact-card uk-padding">
						<div class="fact-header ">
							...
							<div class="fact-title splash-burgundy splash-charter column-header">9:1 Student to Faculty ratio</div>
						</div>
						<div class="fact-body uk-margin-top">
							<p>With our manageable size, innovative teaching methods and flexible curriculum, we are able to provide the individualized approach each girl needs to excel in all aspects of her education.</p>
						</div>
					</div>
					...
					<div class="fact-card uk-padding">
						<div class="fact-header ">
							...
							<div class="fact-title splash-burgundy splash-charter column-header">9:1 Student to Faculty ratio helo hello hello</div>
						</div>
						<div class="fact-body uk-margin-top">
							<p>With our manageable size, innovative teaching methods and flexible curriculum, we are able to provide the individualized approach each girl needs to excel in all aspects of her education.</p>
						</div>
		...
		<!--NEWS AREA-->
		<section class="uk-section uk-padding spring-wood-bg">
			<div class="uk-padding uk-text"><div class="uk-text-left splash-burgundy splash-charter section-title"><span>News and Announcement</span></div></div>
			<div class="uk-padding-large uk-text">
				
					<div class="uk-child-width-1-4@m uk-padding" uk-grid>
						<div>
							<div class="uk-card ">
								<div class="uk-card-media-top">
									<img src="images/children-cute-enjoyment-1432697.jpg" alt="">
								</div>
								<div class="uk-card-body uk-padding-remove">
									<p class="uk-card-title uk-margin-top">Media Top</p>
						...
						<div>
							<div class="uk-card ">
								<div class="uk-card-media-top">
									<img src="images/blur-children-class-448877.jpg" alt="">
								</div>
								<div class="uk-card-body uk-padding-remove">
									<h3 class="uk-card-title uk-margin-top">Media Top</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. </p>
								</div>
							</div>
							<div class="uk-card-footer uk-padding-remove">
						...
						<div>
							<div class="uk-card ">
								<div class="uk-card-media-top">
									<img src="images/children-close-up-crowd-764681.jpg" alt="">
								</div>
								<div class="uk-card-body uk-padding-remove">
									<h3 class="uk-card-title uk-margin-top">Media Top</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
