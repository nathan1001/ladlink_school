<?php
	...
	*/
				...
				<a class="card-link" href="http://ladlinkschool.com/academics.html">
					<div class="uk-padding ">
						...
						<div class="school-menu-text-age">
							<div class=" school-age-number splash-burgundy"><?= $object['_school_age_range']?></div> <div class="superscript splash-burgundy">years old</div>
						</div>
	...
	<section class="uk-section uk-padding-remove uk-margin-large-top" >
			...
			<div class="home-head" style="background-image: url('<?=$_headmistress_image?>')">
				
			</div>
			<div class="message-box">
				<div class="uk-padding uk-text mobile-padding">
					<div class="underline-header column-title"><?=$_title_message_from_the_head?></div>
					<p class="text-body"><?=$_message_from_headmistress?></p>
				</div>
			</div>
	...
	<section class="uk-section  section-width">
		<div class=" uk-text"><div class="uk-text-left splash-burgundy splash-charter section-title"><span><?=$_ladlink_at_glance_title?></span></div></div>
		<div class="margin-from-title">
			<div class=" uk-text-left" >

			<?foreach( $_ladlink_at_a_glance_entry_one as $object ){?>
				<div class="fact-card">
					<div class="fact-header left-fact-padding">
						...
						<div class="fact-title splash-burgundy splash-charter column-header"><?$object['_entry_title']?></div>
					</div>
					<div class="fact-body uk-margin-top left-fact-padding" >
						<p class="text-body"><?$object['_entry_description']?></p>
					</div>
				</div>
				<?}?>
				
				<?foreach( $_ladlink_at_a_glance_entry_two as $object ){?>
				<div class="fact-card">
				...
				<?foreach( $_ladlink_at_a_glance_entry_three as $object ){?>
				<div class="fact-card">
	...
	<section class="uk-section spring-wood-bg ">
		...
		<div class=" uk-text  section-width">
			...
			<?foreach( $_news_post as $object ){?>
				<div class="news-card">
					<div class="uk-card ">
						<div class="uk-card-media-top">
							<img src="<?=$object['_news_post_image']?>" alt="">
						</div>
						<div class="uk-card-body uk-padding-remove">
							<p class="uk-card-title uk-margin-top"><?=$object['_news_post_title']?></p>
							<p class="text-body"><?=$object['_news_post_description']?></p>
						</div>
						<div class="uk-card-footer uk-padding-remove">
							<a href="<?=$object['_news_post_link']?>" class="uk-button uk-button-text splash-burgundy">Read more</a>
						</div>
					</div>
				</div>
				<?}?>			
